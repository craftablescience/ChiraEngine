...
ModelViewerPanel::ModelViewerPanel() : IPanel(TR("ui.engineview.title"), true) {
    this->flags |=
...
void ModelViewerPanel::convertToModelTypeSelected(const std::string& extension, const std::string& type) const {
...
std::string_view ModelViewerPanel::getMeshId() const {
    return this->meshId;
}
...
int main(int argc, const char* const argv[]) {
    ...
    mainpanelid = Engine::getDevice()->addPanel(new ModelViewerPanel{});
