 ...
 * ChiraEngine Editor
 * 
 * Provides an interface for various editor tools
 * and panels that assist in the creation of a game.
 */
...
void MainEditorPanel::preRenderContents() {
    if (ImGui::BeginMainMenuBar()) {
        ...
        ImGui::Text("              ChiraEngine [` - Open Console]");
...
std::string tpc[14] = {
    ...
    "fmt", "fontawesome",
    "GLAD", "SDL2", "GLM",
    "libfiledialogs - time-killer-games",
...
int main(int argc, const char* const argv[]) {
    ...
    mpid = Engine::getDevice()->addPanel(new MainEditorPanel{});
    Engine::getDevice()->addPanel(new ModelEditor{});
