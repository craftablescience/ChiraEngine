...
# JOLT
set(DOUBLE_PRECISION ${CHIRA_BUILD_WITH_PRECISE_PHYSICS} CACHE BOOL "" FORCE)
set(GENERATE_DEBUG_SYMBOLS ${CHIRA_DEBUG_BUILD} CACHE BOOL "" FORCE)
set(CROSS_PLATFORM_DETERMINISTIC ${CHIRA_BUILD_WITH_DETERMINISTIC_PHYSICS} CACHE BOOL "" FORCE)
set(COMPILE_AS_SHARED_LIBRARY ${BUILD_SHARED_LIBS} CACHE BOOL "" FORCE)
set(INTERPROCEDURAL_OPTIMIZATION ${CHIRA_BUILD_WITH_LTO} CACHE BOOL "" FORCE)
set(USE_STATIC_MSVC_RUNTIME_LIBRARY ${CHIRA_BUILD_WITH_STATIC_MSVC_RUNTIME_LIBRARY} CACHE BOOL "" FORCE)
add_subdirectory(${CMAKE_CURRENT_LIST_DIR}/thirdparty/jolt/Build)
list(APPEND CHIRA_ENGINE_INCLUDE_DIRS ${CMAKE_CURRENT_LIST_DIR}/thirdparty/jolt)
list(APPEND CHIRA_ENGINE_LINK_LIBRARIES Jolt)
...
include(${CMAKE_CURRENT_LIST_DIR}/reflect/CMakeLists.txt)
