...
static ConVar log_timestamp{"log_timestamp", true, "Print the timestamp of a console message in the terminal.", CON_FLAG_CACHE}; // NOLINT(cert-err58-cpp)
static ConVar log_source{"log_source", true, "Print the source of a console message in the terminal and console panel.", CON_FLAG_CACHE}; // NOLINT(cert-err58-cpp)
