...
namespace chira {
    ...
    public:
        Mesh3d(Entity* parent_, SharedPointer<MeshResource> mesh_)
            : Entity3d(parent_)
            , mesh(std::move(mesh_)) {}
        Mesh3d(Entity* parent_, const std::string& name_, SharedPointer<MeshResource> mesh_)
            : Entity3d(parent_, name_)
            , mesh(std::move(mesh_)) {}
        explicit Mesh3d(SharedPointer<MeshResource> mesh_)
            : Entity3d()
            , mesh(std::move(mesh_)) {}
        Mesh3d(const std::string& name_, SharedPointer<MeshResource> mesh_)
            : Entity3d(name_)
            , mesh(std::move(mesh_)) {}
