...
namespace chira {
    ...
    public:
        Freecam(Entity* parent_, CameraProjectionMode mode, float fov_ = 90.f) : Camera(parent_, mode, fov_) {}
        Freecam(Entity* parent_, const std::string& name_, CameraProjectionMode mode, float fov_ = 90.f) : Camera(parent_, mode, fov_) {}
        explicit Freecam(CameraProjectionMode mode, float fov_ = 90.f) : Camera(mode, fov_) {}
        Freecam(const std::string& name_, CameraProjectionMode mode, float fov_ = 90.f) : Camera(name_, mode, fov_) {}
