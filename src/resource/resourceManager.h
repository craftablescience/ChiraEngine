...
public:
    ...
    static resourceType* getCachedResource(const std::string& identifier) {
        ...
        chira::logger::log(ERR, "Resource Manager", fmt::format(TR("error.resource_manager.cached_resource_not_found"), identifier));
        return nullptr;
    }
    ...
    static std::unique_ptr<resourceType> getResourceWithoutCaching(const std::string& identifier, Params... params) {
        ...
        chira::logger::log(WARN, "Resource Manager", fmt::format(TR("error.resource_manager.resource_not_found"), identifier));
        return nullptr;
    }
