...
TEST(AngelScriptHelpers, TypeStringSimple) {
...
TEST(AngelScriptHelpers, TypeStringConstRef) {
...
TEST(AngelScriptHelpers, TypeStringPtr) {
...
TEST(AngelScriptHelpers, TypeStringConstPtr) {
